...
public class MoveforGhost : MonoBehaviour
{
	...
	private void NextWaypoint()
	{
		if(isCircular) {
			...
			currentIndex = (!inReverse) ? currentIndex+1 : currentIndex-1;
				...
				if (currentWaypoint == wayPoints[1] || currentWaypoint == wayPoints[2] || currentWaypoint == wayPoints[3] || currentWaypoint == wayPoints[7] || currentWaypoint == wayPoints[8]){
		RotateRight();
		}else{
		RotateLeft();
		}
